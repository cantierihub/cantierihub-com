            ...
            <div className="prose prose-sm text-gray-600 space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { tipo: "Cookie pubblicitari (richiedono il tuo consenso)", desc: "Se accetti, carichiamo il Meta Pixel di Facebook e Instagram: ci dice quante persone arrivano dalle nostre inserzioni e quante ci chiedono informazioni, e ci permette di non mostrare le stesse pubblicità a chi ci ha già scritto. A Meta inviamo solo la pagina visitata e, se compili il modulo, il servizio che hai scelto: mai il tuo nome, la tua email, il tuo telefono o il testo del messaggio. Senza il tuo consenso non viene nemmeno scaricato. Non usiamo TikTok Pixel né Google Analytics.", esempio: "Meta Pixel (fbq)" },
                ].map((c) => (
