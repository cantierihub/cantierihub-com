  ...
  return (
    ...
    >
      <Reveal>
        ...
        <p style={{ fontSize: "clamp(16px, 1.3vw, 19px)", color: dark ? "#94a3b8" : "#64748b", marginBottom: 36, position: "relative" }}>
          {subtitle}
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3" style={{ position: "relative" }}>
          <Link href={primaryHref} className="btn-primary btn-lg cta-shimmer">
            {primaryLabel} <span className="arrow">→</span>
          </Link>
          {whatsapp && (
            <Link href="/contatti" className="btn-whatsapp btn-lg">
        ...
        <p style={{ fontSize: 13, color: dark ? "#475569" : "#94a3b8", marginTop: 20, position: "relative" }}>
