...
interface CTASectionProps {
  ...
  whatsappText?: string;
  /** Destinazione del CTA primario. Se e' un percorso interno non apre una nuova scheda. */
  primaryHref?: string;
    ...
    >
      ...
      <Reveal>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3" style={{ position: "relative" }}>
          ...
          {whatsapp && (
            <a href={hrefWhatsapp} target="_blank" rel="noopener noreferrer" className="btn-whatsapp btn-lg">
